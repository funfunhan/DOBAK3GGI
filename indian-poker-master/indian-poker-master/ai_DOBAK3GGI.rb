...
class MyAi
  ...
  def calculate(info)
    ...
    if (@@RivalCoinHistory[(@@round-2)] - @@RivalCoinHistory[(@@round-1)]).abs == @@pRBet[@@round-2]
      ...
      if @@firstOrlast[(@@round-1)] == 1
        if (@@MyCoinHistory[(@@round-2)] - @@MyCoinHistory[(@@round-1)]).abs == @@pRBet[@@round-2]
          ...
          if (@@MyCoinHistory[(@@round-2)] - @@MyCoinHistory[(@@round-1)]).abs != 0
            @@pRBet[(@@round-2)] = (@@MyCoinHistory[(@@round-2)] - @@MyCoinHistory[(@@round-1)]).abs
            @@pRBet[(@@round-1)] = your_total_bet
          end
        end
      else
        if @@pRBet[(@@round-1)] > @@pMBet[(@@round-1)]
          @@pRBet[(@@round-1)] = your_total_bet
        else
          if (@@MyCoinHistory[(@@round-2)] - @@MyCoinHistory[(@@round-1)]).abs != 0
            @@pRBet[(@@round-1)] = your_total_bet
    ...
    gap_coin = 0
    gap_coin = @@MyCoinHistory.last - @@RivalCoinHistory.last
    ### 현재 라운드의 코인 갯수 차이가 남은 라운드 수의 두 배가 넘을 경우 무조건 승리

    victory = false
    stability = gap_coin / ((21 - @@round).to_f)
    ...
    if victory == true
      ...
      if (bet_history.count % 2) == 0
        if @@round == 1
          ...
          elsif win_percent >= 20 && win_percent < 50   ##상대 카드가 2일때
            maxbetting = 2
            if your_total_bet > my_total_bet  # 상대방이 나의 배팅보다 더 많이 배팅 했을때
              if your_total_bet > maxbetting  # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                this_bet = -1
          ...
          elsif win_percent < 20   ##상대 카드가 2일때
            this_bet = -1
          end
          ...
          if win_percent >= 99              ##상대 카드가 1일때 = 무한
            ...
            if win_percent >= 90
              maxbetting = 6
            else (win_percent >= 85) && (win_percent < 90)
              maxbetting = 5
            end
          ...
          elsif win_percent >= 26 && win_percent < 50   ##상대 카드가 2일때
            maxbetting = 2
            if your_total_bet > my_total_bet  # 상대방이 나의 배팅보다 더 많이 배팅 했을때
              if your_total_bet > maxbetting  # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                this_bet = -1
          ...
          elsif win_percent < 26   ##상대 카드가 2일때
            this_bet = -1
          end
          ...
          if (gap_coin >= 24)
          ...
          elsif (gap_coin >= 20)                  ### 안정도 2가 조금 안되는 상황
            if (win_percent > 98)
                              # 무조건 이길 때의 베팅
              if(your_total_bet > my_total_bet)     #상대가 레이즈를 했을 떄
                if(your_total_bet - my_total_bet == my_money)
            ...
            elsif (win_percent >= 81)
              if your_total_bet > 2
                this_bet = -1
              else
                this_bet = 1
              end
            elsif (win_percent >= 54)
              if your_total_bet > 1
                this_bet = -1
              else
                this_bet = 1
            ...
            if (win_percent > 98)
              ...
              if your_total_bet > 5
                this_bet = -1
              elsif your_total_bet == 5
                this_bet = your_total_bet - my_total_bet
              elsif your_total_bet == my_total_bet
                this_bet = 2
              else
                this_bet = your_total_bet-my_total_bet + 1
              end
          ...
          if (gap_coin >= 24)
            ...
            elsif (win_percent >= 80)
              if your_total_bet > 2
                this_bet = -1
              else
                this_bet = 1
              end
            elsif (win_percent >= 57)
              if your_total_bet > 1
                this_bet = -1
              else
                this_bet = 1
            ...
            if (win_percent > 98)
              ...
              if your_total_bet > 2 + @rival_average_betting
                this_bet = -1
              elsif your_total_bet == 2 + @rival_average_betting
                this_bet = your_total_bet - my_total_bet
              else
                this_bet = 1
              end
            ...
            if (win_percent > 98)
              ...
              if your_total_bet > 5 + @rival_average_betting
                this_bet = -1
              elsif your_total_bet == 5 + @rival_average_betting
                this_bet = your_total_bet - my_total_bet
              elsif your_total_bet == my_total_bet
                this_bet = 2
              else
              ...
              if your_total_bet > 4 + @rival_average_betting
                this_bet = -1
              elsif your_total_bet == 4 + @rival_average_betting
                this_bet = your_total_bet - my_total_bet
              elsif your_total_bet == my_total_bet
                this_bet = 2
              else
              ...
              if your_total_bet > 3 + @rival_average_betting
                this_bet = -1
              elsif your_total_bet == 3 + @rival_average_betting
                this_bet = your_total_bet - my_total_bet
              elsif your_total_bet == my_total_bet
                this_bet = 2
              else
            ...
            if (win_percent > 98)
              ...
              if your_total_bet > 6 + @rival_average_betting
                this_bet = -1
              elsif your_total_bet == 6 + @rival_average_betting
                this_bet = your_total_bet - my_total_bet
              elsif your_total_bet == my_total_bet
                this_bet = 3
              else
            ...
            if (win_percent > 98)
              ...
              if your_total_bet > 7 + @rival_average_betting
                this_bet = -1
              elsif your_total_bet == 7 + @rival_average_betting
                this_bet = your_total_bet - my_total_bet
              elsif your_total_bet == my_total_bet
                this_bet = 3
              else
          ...
          if opposite_play_card == 1              ##상대 카드가 1일때 = 무한
            ...
            maxbetting = 5 + @rival_average_betting
            if your_total_bet > my_total_bet  # 상대방이 나의 배팅보다 더 많이 배팅 했을때
              if your_total_bet > maxbetting  # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                this_bet = -1
              else    # 상대방의 총 배팅이 최대 배팅보다 낮을 경우 최대까지 남은 배팅을 한다.
            ...
            maxbetting = 4 + @rival_average_betting
            if your_total_bet > my_total_bet # 상대방이 나의 배팅보다 더 많이 배팅 했을때
              if your_total_bet > maxbetting # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                this_bet = -1 # die
              else # 상대방의 총 배팅이 최대 배팅보다 낮을 경우 최대까지 남은 배팅을 한다.
            ...
            maxbetting = 3 + @rival_average_betting
            if your_total_bet > my_total_bet # 상대방이 나의 배팅보다 더 많이 배팅 했을때
              if your_total_bet > maxbetting # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                this_bet = -1 # die
              else # 상대방의 총 배팅이 최대 배팅보다 낮을 경우 최대까지 남은 배팅을 한다.
          ...
          randomNumForBetting = rand(1..100)
          if win_percent == 100              ##상대 카드가 1일때 = 무한
            if your_total_bet > my_total_bet      # 상대방이 나의 배팅보다 더 많이 배팅 했을때
              if randomNumForBetting < 33         #랜덤 확률(33% 이하)
                this_bet = your_total_bet - my_total_bet + 1    #상대방이 건 배팅 보다 무조건 1더 많게 건다. (무제한 배팅)
              elsif randomNumForBetting < 66 && randomNumForBetting >= 33       #랜덤 확률(33% 이상 66% 미만)
           ...
           if gap_coin > 8
              case win_percent
                 ...
                 when 81...90
                    maxbetting = 2 + @rival_average_betting
                    if your_total_bet > my_total_bet   # 상대방이 나의 배팅보다 더 많이 배팅 했을때
                       if your_total_bet > maxbetting   # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                          this_bet = -1
                       else
           ...
           elsif gap_coin.between?(-8,-5)
              case win_percent
                 when 90..100
                    maxbetting = 6 + @rival_average_betting
                    if your_total_bet > my_total_bet   # 상대방이 나의 배팅보다 더 많이 배팅 했을때
                       if your_total_bet > maxbetting   # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                          this_bet = -1
                       else                     # 아직 더 걸 수 있다면
              ...
              case win_percent
                 when 90..100
                    maxbetting = 10 + @rival_average_betting
                    if your_total_bet > my_total_bet   # 상대방이 나의 배팅보다 더 많이 배팅 했을때
                       if your_total_bet > maxbetting   # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                          this_bet = -1
                       else                     # 아직 더 걸 수 있다면
                 ...
                 when 81...90
                    maxbetting = 9 + @rival_average_betting
                    if your_total_bet > my_total_bet   # 상대방이 나의 배팅보다 더 많이 배팅 했을때
                       if your_total_bet > maxbetting   # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                          this_bet = -1
                       else                     # 아직 더 걸 수 있다면
                 ...
                 when 62...71
                    maxbetting = 8 + @rival_average_betting
                    if your_total_bet > my_total_bet   # 상대방이 나의 배팅보다 더 많이 배팅 했을때
                       if your_total_bet > maxbetting   # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                          this_bet = -1
                       else                     # 아직 더 걸 수 있다면
                 ...
                 when 45...52
                    maxbetting = 7 + @rival_average_betting
                    if your_total_bet > my_total_bet   # 상대방이 나의 배팅보다 더 많이 배팅 했을때
                       if your_total_bet > maxbetting   # 상대방의 총배팅이 최대 배팅보다 클때 = 다이
                          this_bet = -1
                       else                     # 아직 더 걸 수 있다면
          ...
          if (gap_coin == 7 || gap_coin == 8)
            if (win_percent > 85)
              maxbetting = 5 + @rival_average_betting
              if your_total_bet > my_total_bet
                if your_total_bet > maxbetting
                  this_bet = -1
                else
                  temp1 = (your_total_bet - my_total_bet)
                  temp2 = (maxbetting - my_total_bet)
          ...
          if ((gap_coin == 0) || (gap_coin == 1)) || ((gap_coin >= -8) && (gap_coin <= -5))
            maxbetting = 4 + @rival_average_betting
            if (win_percent > 75)
              if your_total_bet > my_total_bet
                if your_total_bet > maxbetting
    ...
    if this_bet > my_money
      this_bet = my_money
    end

    if this_bet > (60 - (my_money + my_total_bet + your_total_bet))
